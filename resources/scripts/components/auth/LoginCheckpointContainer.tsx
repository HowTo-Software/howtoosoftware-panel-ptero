...
const LoginCheckpointContainer = () => {
    ...
    return (
        <LoginFormContainer title={translateUiText('Device Checkpoint')} css={tw`w-full flex`}>
            <div css={tw`mt-6`}>
                <Field
                    light
                    name={isMissingDevice ? 'recoveryCode' : 'code'}
                    title={isMissingDevice ? translateUiText('Recovery Code') : translateUiText('Authentication Code')}
                    description={
                        isMissingDevice
                            ? translateUiText(
                                  'Enter one of the recovery codes generated when you setup 2-Factor authentication on this account in order to continue.'
                              )
                            : translateUiText('Enter the two-factor token generated by your device.')
                    }
                    type={'text'}
            ...
            <div css={tw`mt-6 text-center`}>
                ...
                >
                    {!isMissingDevice ? translateUiText("I've Lost My Device") : translateUiText('I Have My Device')}
                </span>
            </div>
            <div css={tw`mt-6 text-center`}>
                <Link

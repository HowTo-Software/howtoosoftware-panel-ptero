            ...
            <div className={'col-span-10 sm:col-span-9 flex'}>
                <div className={'flex-1 px-4 sm:px-0'}>
                    <div className={'flex items-center text-gray-50'}>
                        <Tooltip placement={'top'} content={actor?.email || translateUiText('System User')}>
                            <span>{actor?.username || translateUiText('System')}</span>
                        </Tooltip>
                        ...
                        <div className={classNames(style.icons, 'group-hover:text-gray-300')}>
                            {activity.isApi && (
                                <Tooltip placement={'top'} content={translateUiText('Using API Key')}>
                                    <TerminalIcon />
                                </Tooltip>
                            )}
                            {activity.event.startsWith('server:sftp.') && (
                                <Tooltip placement={'top'} content={translateUiText('Using SFTP')}>
                                    <FolderOpenIcon />
                                </Tooltip>
                            )}
                            {children}
